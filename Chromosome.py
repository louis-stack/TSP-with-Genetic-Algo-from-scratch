...
"""
temp = pd.read_excel("data.xlsx").values.tolist()
for elem in temp:
    dataset.append(Node(elem[0], elem[1], elem[2]))

N = 52  # Total number of unique points, including starting point
...
class Chromosome:
    def get_cost(self):
        return self.cost
    def __repr__(self):
        return "chr_representation : " + str(self.chr_representation) + ", cost : " + str(self.cost) + ", fitness_value : " + str(self.fitness_value) 
